...
> ⚠️ **口径提示 (2026-09-12 更新)**：个股面板展示的“多头评分”是 0–100 技术规则分，未经概率校准；冰点面板展示的是历史分箱估计并附样本外诊断，均非胜率承诺。在线“历史相似形态”是样本内价格路径描述，不是可交易回测。方法与局限详见 [ALGORITHM_REVIEW_2026-09-12.md](ALGORITHM_REVIEW_2026-09-12.md)。
